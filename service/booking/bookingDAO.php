...
// Hàm lấy booking gần nhất từ computer_id
function get_lastest_booking_by_computer_id($computer_id)
{
    $sql = "
        SELECT *
    ...
    return booking_db_query_one($sql, $computer_id);
}
...
// DAO: cập nhật trạng thái đặt chỗ
function dao_update_reservation_status($reservation_id, $status)
{
